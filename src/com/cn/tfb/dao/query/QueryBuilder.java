...
import com.cn.tfb.dao.InternalQueryDaoAccess;
import com.cn.tfb.dao.Property;
import com.cn.tfb.dao.internal.SqlUtils;
import com.cn.tfb.dao.query.WhereCondition.PropertyCondition;
...
public class QueryBuilder<T>
{
	...
	protected void checkProperty(Property property)
	{
		if (dao != null)
		{
			...
			if (!found) { throw new DaoException("Property '" + property.name
					+ "' is not part of " + dao); }
		}
	}
	...
	public Query<T> build()
	{
		...
		if (offset != null)
		{
			if (limit == null) { throw new IllegalStateException(
