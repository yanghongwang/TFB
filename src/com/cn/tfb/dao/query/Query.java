...
public class Query<T> extends AbstractQuery<T>
{
	...
	{
		if (index >= 0 && (index == limitPosition || index == offsetPosition)) { throw new IllegalArgumentException(
				"Illegal parameter index: " + index); }
	...
	{
		checkThread();
		if (limitPosition == -1) { throw new IllegalStateException(
	...
	{
		checkThread();
		if (offsetPosition == -1) { throw new IllegalStateException(
	...
	{
		T entity = unique();
		if (entity == null) { throw new DaoException(
