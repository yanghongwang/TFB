...
public interface WhereCondition
{
	...
	public static class PropertyCondition extends AbstractCondition
	{
		...
		{
			if (value != null && value.getClass().isArray()) { throw new DaoException(
					...
					|| property.type == Boolean.class)
			{
				...
				else if (value instanceof Number)
				{
					...
					if (intValue != 0 && intValue != 1) { throw new DaoException(
		...
		private static Object[] checkValuesForType(Property property,
				Object[] values)
		{
