package com.cn.tfb.dao.internal;
...
public final class DaoConfig implements Cloneable
{
			...
			Class<? extends AbstractDao<?, ?>> daoClass)
	{
		...
		try
		{
			this.tablename = (String) daoClass.getDeclaredField("TABLENAME")
					.get(null);
			...
			IllegalAccessException
	{
		...
		{
			if (properties[property.ordinal] != null) { throw new DaoException(
