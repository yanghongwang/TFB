...
public final class LongHashMap<T>
{
	...
	{
		final int index = ((((int) (key >>> 32)) ^ ((int) (key))) & 0x7fffffff)
				% capacity;
	...
	{
		int index = ((((int) (key >>> 32)) ^ ((int) (key))) & 0x7fffffff)
				% capacity;
	...
	public void logStats()
	{
		...
		DaoLog.d("load: " + ((float) size) / capacity + ", size: " + size
				+ ", capa: " + capacity + ", collisions: " + collisions
				+ ", collision ratio: " + ((float) collisions) / size);
	}
