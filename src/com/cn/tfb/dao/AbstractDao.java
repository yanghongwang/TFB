...
import com.cn.tfb.dao.internal.FastCursor;
import com.cn.tfb.dao.internal.TableStatements;
import com.cn.tfb.dao.query.Query;
import com.cn.tfb.dao.query.QueryBuilder;
import com.cn.tfb.dao.scope.IdentityScope;
import com.cn.tfb.dao.scope.IdentityScopeLong;
...
public abstract class AbstractDao<T, K>
{
	...
	protected T loadUnique(Cursor cursor)
	{
		...
		else if (!cursor.isLast()) { throw new DaoException(
	...
	final protected T loadCurrent(Cursor cursor, int offset, boolean lock)
	{
		if (identityScopeLong != null)
		{
			if (offset != 0)
			{
				if (cursor.isNull(pkOrdinal + offset)) { return null; }
			}
		...
		else if (identityScope != null)
		{
			...
			if (offset != 0 && key == null) { return null; }
	...
	{
		if (config.pkColumns.length != 1) { throw new DaoException(this + " ("
				+ config.tablename
