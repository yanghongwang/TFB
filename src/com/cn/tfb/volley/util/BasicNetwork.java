...
import com.cn.tfb.volley.Network;
import com.cn.tfb.volley.NetworkError;
import com.cn.tfb.volley.NetworkResponse;
import com.cn.tfb.volley.NoConnectionError;
import com.cn.tfb.volley.Request;
import com.cn.tfb.volley.RetryPolicy;
import com.cn.tfb.volley.ServerError;
import com.cn.tfb.volley.TimeoutError;
...
public class BasicNetwork implements Network
{
			...
			throws VolleyError
	{
		...
		while (true)
		{
			...
			try
			{
				...
				Logger.e("Time", String.valueOf(endTime - startTime));

				responseHeaders = convertHeaders(httpResponse.getAllHeaders());
				if (statusCode == HttpStatus.SC_NOT_MODIFIED) { return new NetworkResponse(
			...
			ServerError
	{
		...
		try
		{
			...
			if (in == null) { throw new ServerError(); }
