...
public class JSONSerializer
{
	...
	{
		if (dateFormat instanceof SimpleDateFormat) { return ((SimpleDateFormat) dateFormat)
				.toPattern(); }
	...
	public void setContext(SerialContext parent, Object object,
			Object fieldName, int features)
	{
		if (isEnabled(SerializerFeature.DisableCircularReferenceDetect)) { return; }
	...
	public ObjectSerializer getObjectWriter(Class<?> clazz)
	{
		...
		if (writer == null)
		{
			...
			else if (clazz.isArray())
			{
				...
				config.put(clazz, new ArraySerializer(componentType,
						compObjectSerializer));
			}
