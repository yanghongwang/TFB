			...
			Object fieldName)
	{
		if (type instanceof GenericArrayType)
		{
			...
			if (componentType instanceof Class)
			{
				...
				{
					return (T) TypeUtils.cast(list, boolean[].class,
							parser.getConfig());
				}
				...
				{
					return (T) TypeUtils.cast(list, int[].class,
							parser.getConfig());
				}
				else if (componentClass == long.class)
				{
					return (T) TypeUtils.cast(list, long[].class,
							parser.getConfig());
				}
				else if (componentClass == float.class)
				{
					return (T) TypeUtils.cast(list, float[].class,
							parser.getConfig());
				}
				else if (componentClass == double.class) { return (T) TypeUtils
						.cast(list, double[].class, parser.getConfig()); }
