...
public class ExternalOverFroyoUtils
{
	...
	{
		if (AndroidVersionCheckUtils.hasGingerbread()) { return path
				.getUsableSpace(); }
	...
	{
		if (AndroidVersionCheckUtils.hasFroyo()) { return context
				.getExternalCacheDir(); }
	...
	{
		if (AndroidVersionCheckUtils.hasGingerbread()) { return Environment
